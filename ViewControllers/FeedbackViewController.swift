...
class FeedbackViewController: UIViewController {
    ...
    @objc private func submitButtonAction() {
        ...
        let MessageAlert = UIAlertController.init(title: "Success", message: "Thanks for your feedback, I will reply you as soon as possible. ", preferredStyle: .alert)
        let OKAlert = UIAlertAction.init(title: "OK", style: .default) { (OKAlert) in self.backButtonAction()
        }
        MessageAlert.addAction(OKAlert)
