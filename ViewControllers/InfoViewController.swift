...
class InfoViewController: UIViewController {
    ...
    @objc private func shareButtonAction() {
        let message = "Checkout Words Parse!! It helps you parsing any scrambled english word. https://itunes.apple.com/us/app/Words-Parse/id1472970533"
        let activityViewController = UIActivityViewController(activityItems: [message], applicationActivities: nil)
        self.present(activityViewController, animated: true)
    }

    @objc private func rateButtonAction() {
        let url = URL(string: "itms-apps://itunes.apple.com/app/id1472970533")!
