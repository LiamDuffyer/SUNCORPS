...
//    private var backUIimage: UIImageView! = {
//        let cacheuimage = UIImageView.init(frame: CGRect.init(x: 0, y: 0, width: UIScreen.main.bounds.size.width, height: UIScreen.main.bounds.size.height))
//        cacheuimage.image = UIImage.init(named: "WordParseLaunch")
//        return cacheuimage
//    }()
    // MARK: Attributes
    ...
    override func viewDidLoad() {
        ...
        DispatchQueue.global().async {
            ...
            self.unscrambler = UnScrambler.getInstance()
            self.staredWordsController = StaredWordsController.getInstance()
            self.firebaseEvents = FirebaseEvents()
        }
...
//        self.view.addSubview(self.backUIimage)
...
//        if(cell.infoButton.isHidden == false)
//        {
//
//        }
...
//        cell.moreDefinitionsButton.isHidden = item.definitionExists
        ...
        cell.moreDefinitionsButton.isHidden = false
        return cell
    }
...
extension MainViewController {
    ...
    private func setupNavigationBar() {
        ...
        titleLabel.text = Message.WORDSPARSE
